...
def main():
	...
	print("Greetings, This simple program allows a user to generate a simple 3D rectangle and fill it with porosity")

	# Determine the dimensions of a cube and step (step determines how dense points will be)
	max_x = input("Enter a Max x dimension: ")
	max_y = input("Enter a Max y dimension: ")
	max_z = input("Enter a Max z dimension: ")
	step = 1
